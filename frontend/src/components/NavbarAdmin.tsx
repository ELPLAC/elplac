...
const NavbarAdmin: React.FC = () => {
  ...
  return (
    <div
      className={`flex w-full lg:pr-16 h-full items-center justify-end `} style={{ backgroundColor: "#fffcf3" }}>
      <ul
        className={`flex text-xl lg:gap-6 font-semibold text-primary-darker items-center gap-24 md:gap-1 xl:gap-5`}>
        <li>
          <div className="sm:mr-5 self-start ">
            <Link href="/">
              <Image alt="logo" src={logo} width={200} height={150}></Image>
            </Link>
          </div>
        </li>
